...
class RebuildCategoriesTree extends Command
{
     ...
     * @var string
     */
    protected $signature = 'categoriestree:rebuild';
     ...
     * @var string
     */
    protected $description = 'Rebuild the Nested Set tree for the Category model';

    public function handle(CategoryService $categoryService)
    {
        try {
            $this->info('Starting to rebuild the nested set tree for the Category model...');
            ...
            $this->info('Nested set tree for the Category model has been rebuilt successfully!');
